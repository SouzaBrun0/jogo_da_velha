...
//limpra o jogo, declara o vencedor e atualizar o placar
function declareWinner(winner){
    let scooreboardx = document.querySelector("#scoreboard-1");
    let scooreboardy = document.querySelector("#scoreboard-2");
    let msg = '';
